...
- [Upload de fichiers](#upload-de-fichiers)
  ...
  - [Après $_GET, $_POST...le tableau $_FILES](#après-_get-_postle-tableau-_files)
  - [Types de contenus et encodage des données de formulaire](#types-de-contenus-et-encodage-des-données-de-formulaire)
  - [Propriétés du fichier et configuration PHP](#propriétés-du-fichier-et-configuration-php)
  - [Gestion des erreurs et configuration](#gestion-des-erreurs-et-configuration)
  - [Enregistrement d'un fichier sur le serveur](#enregistrement-dun-fichier-sur-le-serveur)
  - [Enregistrer plusieurs fichiers en même temps](#enregistrer-plusieurs-fichiers-en-même-temps)
  - [Lien avec une base de données](#lien-avec-une-base-de-données)
- [Sessions](#sessions)
